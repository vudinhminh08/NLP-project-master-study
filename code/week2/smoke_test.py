"""
smoke_test.py — Kiểm tra toàn bộ pipeline Week 2 mà KHÔNG cần GPU hay download PhoBERT.
...
Dùng MockPhoBERT (random weights, cùng interface) để test nhanh:
    ...
    - Report generation (week2_summary.md)

Chạy từ ROOT PROJECT:
    python code/week2/smoke_test.py
...
def t_report_generation():
    ...
    with tempfile.TemporaryDirectory() as d:
        save_path = os.path.join(d, "week2_summary.md")
...
if failed:
    ...
    print("   2. Upload notebooks/week2_phobert_training.ipynb lên Kaggle")
