...
Chạy từ root project:
    python code/week1/export_eda_report.py
...
def build_report():
    ...
    # ── 8. Kết luận ─────────────────────────────────────────────────────────
    add_heading(doc, "8. Kết luận & Định hướng Tuần 2", 1)
    ...
    doc.add_paragraph()
    add_paragraph(doc,
        "Tuần 2: Fine-tune PhoBERT (vinai/phobert-base) với multi-task learning — "
